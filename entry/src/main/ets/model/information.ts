...
export class UserStore {
  private static staticData: Record<string, DailyData> = {
    '2026-01-19': { height: 175, weight: 70.5, age: 25, bmi: 23.02, bmr: 1700, recommendedWater: 2000, actualWater: 2100 },
    '2026-01-18': { height: 175, weight: 71.0, age: 25, bmi: 23.18, bmr: 1700, recommendedWater: 2000, actualWater: 1800 }
  }
